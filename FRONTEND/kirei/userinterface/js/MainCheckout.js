            ...
            <div class="navbar">
                ...
                <ul class="horizontal-nav">
                    ...
                    <mask id="path-4-outside-1_0_1" maskUnits="userSpaceOnUse" x="0.919998" y="14.776"
                        width="135" height="38" fill="white">
            ...
            if (product) {
                ...
                <tr id="Cart-Info-${productId}">
                    ...
                    <td>
                        ...
                        <label class="label-out-stock-class" id="Label-Out-Stock-${productId}"></label>
                    </td>
...
async function createCouponAndCheckout() {
    ...
    <div class="item coupon">
        <div class="coupon-position">
            ...
            <label class="label-coupon-class" id="Coupon-Label"></label>
        </div>
    ...
    <div class="item checkout" id="Checkout"> 
        ...
        <label class="label-receipt-class" id="Reciept"></label>
    </div>
    `;
